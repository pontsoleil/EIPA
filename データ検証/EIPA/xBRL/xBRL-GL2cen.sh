...
}
{
  ...
  if ("u"==mode) {
    printf "    <presentationArc xlink:type=\"arc\" xlink:arcrole=\"http://www.xbrl.org/2003/arcrole/parent-child\" xlink:from=\"gl-%s_%s\" xlink:to=\"gl-%s_%s\" priority=\"1\" xlink:title=\"presentation: %s to %s\" use=\"prohibit\"/>\n", p_module, terms[parent], module, term, terms[parent], term, seq;
