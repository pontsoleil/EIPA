...
MVNリポジトリーの[PH Schematron Maven Plugin](https://mvnrepository.com/artifact/com.helger.maven/ph-schematron-maven-plugin)を使用してschematronを変換している。
Maven plugin to apply Schematron rules to XML files on build time
```
