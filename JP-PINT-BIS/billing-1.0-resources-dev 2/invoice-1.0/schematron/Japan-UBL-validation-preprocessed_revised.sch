...
<!--
  ...
  <!--
      <assert id="jp-aa-02" flag="fatal" test="
        ...
        not(exists(//cac:ClassifiedTaxCategory[normalize-space(cbc:ID)='AA']))
      ">
      ...
      <assert id="jp-aa-03" flag="fatal" test="
        ...
        not(exists(//cac:AllowanceCharge[cbc:ChargeIndicator=false()]/cac:TaxCategory[normalize-space(cbc:ID)='AA'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']))
      ">
  ...
  <!--
      <assert id="jp-aa-04" flag="fatal" test="
        ...
        not(exists(//cac:AllowanceCharge[cbc:ChargeIndicator=true()]/cac:TaxCategory[normalize-space(cbc:ID)='AA'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']))
      ">
    ...
    <rule context="ubl:Invoice/*[local-name()!='InvoiceLine']/*[@currencyID='JPY'] | ubl:Invoice/*[local-name()!='InvoiceLine']/*/*[@currencyID='JPY'] | //cac:InvoiceLine/cbc:LineExtensionAmount[@currencyID='JPY']">
      <assert id="jp-br-02" flag="fatal" test="matches(normalize-space(.),'^-?[1-9][0-9]*$')">
    ...
    <rule context="/*/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[normalize-space(cbc:ID)='S'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']">
      ...
      <assert id="jp-s-09" flag="fatal" test="
        (
          ...
          round((abs(xs:decimal(../cbc:TaxableAmount)) * (xs:decimal(cbc:Percent) div 100)) * 10 * 10) div 100 
        ) and (
          abs(xs:decimal(../cbc:TaxAmount)) + 1 &gt;
          round((abs(xs:decimal(../cbc:TaxableAmount)) * (xs:decimal(cbc:Percent) div 100)) * 10 * 10) div 100 
        )">
    ...
    <rule context="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID)='S'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT'] | cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID)='S'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']">
      <assert id="jp-s-05" flag="fatal" test="
        (cbc:Percent) &gt; 0
      ">
        [jp-s-05]-In an Invoice line (BG-25) where the Invoiced item Consumption Tax category code (BT-151) is "Standard rated" the Invoiced item Consumption Tax rate (BT-152) shall be greater than zero.
      </assert>
    </rule>
    ...
    <rule context="/*/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[normalize-space(cbc:ID)='AA'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']">
      ...
      <assert id="jp-aa-09" flag="fatal" test="
        ...
        [jp-aa-09]-The Consumption Tax category tax amount (BT-117) in a Consumption Tax breakdown (BG-23) where Consumption Tax category code (BT-118) is "Standard rated" shall equal the Consumption Tax category taxable amount (BT-116) multiplied by the Consumption Tax category rate (BT-119).
      </assert>
      <assert id="jp-aa-10" flag="fatal" test="
        not(cbc:TaxExemptionReason) and not(cbc:TaxExemptionReasonCode)
      ">
        [jp-aa-10]-A Consumption Tax breakdown (BG-23) with Consumption Tax Category code (BT-118) "Standard rate" shall not have a Consumption Tax exemption reason code (BT-121) or Consumption Tax exemption reason text (BT-120).
      </assert>
    </rule>
    ...
    <rule context="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID)='AA'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT'] | cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory[normalize-space(cbc:ID)='AA'][cac:TaxScheme/normalize-space(upper-case(cbc:ID))='VAT']">
      <assert id="jp-aa-05" flag="fatal" test="
        (cbc:Percent) &gt; 0
      ">
        [jp-aa-05]-In an Invoice line (BG-25) where the Invoiced item Consumption Tax category code (BT-151) is "Reduced rated" the Invoiced item Consumption Tax rate (BT-152) shall be greater than zero.
      </assert>
    </rule>
  </pattern>
